    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            <div className="footer-logo">
              <h3 className="footer-logo-text">PASSOIA</h3>
              <span className="footer-logo-tagline">makeup</span>
            </div>
            <p className="footer-description">
              Encontre a maquiagem perfeita para você com nossa experiência de teste virtual.
            </p>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#experimente">Teste Virtual</a></li>
            </ul>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#devolucoes">Trocas e Devoluções</a></li>
        ...
        <div className="footer-bottom">
          <p>&copy; 2024 Passoia Makeup. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
